      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex items-start justify-between">
            ...
            <a
              href="/extensions/blkout-news-curator-v1.0.3.zip"
              download="blkout-news-curator-v1.0.3.zip"
          ...
          <div className="mt-4 p-4 bg-gray-800/50 border border-liberation-gold-divine/20 rounded-lg">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                >
                  Download Extension v1.0.3 <ExternalLink className="w-3 h-3" />
                </a>
              </div>
            </div>
          </div>
